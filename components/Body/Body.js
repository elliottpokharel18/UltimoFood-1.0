...
import DDDD from "../assets/DDDD.svg";

function Body({ Title }) {
  return (
    <div className="">
      <div className="container md:mb-12 flex mt-12 flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
        ...
        <div className="flex items-center justify-center w-full md:mb-24 h-96 md:w-1/2 lg:w-3/5 ">
          <Image
